<?php
        ...
        $pdf->Cell(155,4,"ACUERDO",1,0,'C',0);
        $pdf->Cell(30,4,"RESPONSABLE(S)",1,0,'C',0);
  ...
  ?>
    ...
    <?php
        foreach($resultado as $fila):
              ...
              $pdf->Cell(155,4,substr(utf8_decode($fila['pr_nombre']),0,105),1,0,'L');
              $pdf->Cell(30,4,substr(utf8_decode($fila['pr_colaboradores']),0,30),1,0,'C');
